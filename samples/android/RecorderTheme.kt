 ...
 * - Keep token names stable; update only values when iterating on visual design.
 */
...
// Generated from design-tokens.json (v0.1)
private object RecorderTokens {
    object Light {
        ...
        // Opaque container color = 12% Accent0 over white.
        val AccentContainer = Color(0xFFE6F0FD)
        ...
        // Opaque container color = 12% Danger over white.
        val ErrorContainer = Color(0xFFFDE9E9)
    }
    ...
    object Dark {
        ...
        // Opaque container color = 18% Accent0 over Surface0 (#111A2B).
        val AccentContainer = Color(0xFF162C4E)
        ...
        // Opaque container color = 18% Danger over Surface0 (#111A2B).
        val ErrorContainer = Color(0xFF392230)
    }
}
...
// Shapes from tokens.radius (s/m/l = 8/12/16)
...
// Typography from tokens.type (display/title/body/caption)
